  ...
  return (
    <section className="hero-banner">
      ...
      <div className="hero-banner-overlay">
        <div className="hero-banner-inner">
          <div className="hero-banner-copy">
            ...
            <h1 className="hero-banner-title">副業の総合ガイド｜NEVORA</h1>
            <p className="hero-banner-lead">
              副業の悩みや疑問に、確認できる情報で答える総合ガイド
            </p>
          </div>
        </div>
      </div>
      <div className="hero-banner-mascot">
        <img
          src="/images/mascot/hajimin-normal.svg"
          alt="NEVORA公式マスコット ハジミンちゃん"
          width={72}
          height={72}
          loading="eager"
        />
        <span className="hero-banner-mascot-name">ハジミン</span>
      </div>
    </section>
  );
}
