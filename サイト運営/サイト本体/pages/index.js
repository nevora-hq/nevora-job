...
const PINNED_CATEGORY_NAMES = ["副業の始め方", "Webライティング", "在宅ワーク・働き方"];
...
export default function Home({
  ...
  return (
    <Layout
      title="副業の総合ガイド｜NEVORA｜副業の始め方・案件獲得・税金の情報"
          ...
          <div className="container container--wide">
            ...
            <Link href="/category" className="diagnosis-banner">
              ...
              <span className="diagnosis-banner-text">
                <span className="diagnosis-banner-title">カテゴリから副業を探す</span>
...
// 1024px未満は従来どおり、人気カテゴリー(副業の始め方/Webライティング/在宅ワーク・働き方)のみ表示し、
