...
export default function About() {
  ...
  return (
    <Layout
      title="運営者情報・編集方針 | 副業の総合ガイド｜NEVORA"
      description="副業の総合ガイド｜NEVORAの運営者情報と編集方針です。運営者・出典の扱い・AIの利用範囲・広告ポリシーを公開しています。"
      canonicalPath="/about"
    ...
    >
      ...
      <div className="article-body">
        <p>
          NEVORAは、副業の始め方・案件の取り方・税金や手続きといった疑問に対して、公的機関・業界団体・サービス提供元の公表情報などの確認できる情報源に基づいて答えることを目的とした、副業情報の総合ガイドです。
        </p>
        ...
        <table className="compare-table">
          <tbody>
            <tr>
              ...
              <td>副業の総合ガイド｜NEVORA</td>
            </tr>
            <tr>
              <th>URL</th>
              <td>https://nevora-job.vercel.app/</td>
            </tr>
            <tr>
              <th>運営者</th>
              <td>眞井 虹輝(まない こうき)</td>
        ...
        <p>
          ...
          <a href="/contact">お問い合わせページ</a>
          に記載のメールアドレス宛にご連絡ください。
        </p>

        <h2>NEVORAが大切にしていること</h2>
        <p>
          副業の情報は、「誰でも稼げる」「簡単に月◯万円」といった強い言葉があふれる一方で、その根拠が示されないまま広がっていくことが少なくありません。NEVORAは、断定できることと断定できないことを区別し、<strong>出典を示せる情報だけを記事にする</strong>ことを運営の軸にしています。
        </p>
        <ul>
          <li>
            記事内の重要な事実には、国税庁・厚生労働省・消費者庁・国民生活センターなどの公的機関、業界団体の統計、サービス提供元の公式発表といった確認可能な出典を記載します
          </li>
          <li>「個人の感想」と「確認された事実」を混在させず、体験談を事実のように扱いません</li>
          <li>税金・契約に関わる内容では、制度の一般的な説明にとどめ、個別の判断は公的機関・専門家への確認を促す書き方を徹底します</li>
        </ul>
        ...
        <ul>
          ...
          <li>
            ...
            :医療行為との線引きが必要なテーマ、誤解が健康被害につながりうるテーマは、表現を確認・修正のうえ公開しています
          </li>
          <li>
        ...
        <h2>出典・引用のルール</h2>
        <ul>
          <li>一次情報(公的機関・業界団体・サービス公式)を優先し、まとめサイト・個人ブログのみを根拠とした記述は行いません</li>
          <li>出典は記事末尾の「出典」欄に、発行元・資料名・発表日とあわせてリンクを記載します</li>
          <li>統計や件数などの数値は、出典資料に記載された数値をそのまま用い、切り取りによって印象が変わる編集を行いません</li>
        </ul>

        <h2>お金・働き方に関する情報の取り扱い(YMYLポリシー)</h2>
        <ul>
          <li>
            本サイトの記事は一般的な情報提供を目的としており、<strong>税務・法務・投資に関する個別の助言ではありません</strong>
          </li>
          <li>収入や成果には個人差があるため、記事内では特定の金額を保証せず、相談先・確認先を示すよう努めています</li>
          <li>
            確定申告・住民税・契約などの制度に関わる内容については、制度上の位置づけを出典とともに記載し、個別の判断は税理士等の専門家への確認をすすめています
          </li>
        </ul>
        ...
        <h2>監修体制について</h2>
        <p>
          現在、税理士・社会保険労務士など有資格者によるカテゴリ単位の監修体制を準備中です。監修が開始された記事には、監修者の氏名・資格を明記します。
        </p>
