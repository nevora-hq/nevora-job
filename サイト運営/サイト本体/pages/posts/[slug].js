...
import ArticleDisclaimer, { shouldShowArticleDisclaimer } from "../../components/ArticleDisclaimer";
    ...
    >
      ...
      <article>
        ...
        */}
        ...
        {shouldShowArticleDisclaimer(post.disclaimer) && <ArticleDisclaimer />}
      </article>
    </Layout>
  );
}
